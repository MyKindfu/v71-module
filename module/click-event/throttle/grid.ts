...
const ctors: string[] = throttleMatchingCtor.gridSearchBtn
const defaultLimit: number = defaultThrottleLimits.gridSearchBtn


/** 处理 GRID 搜索按钮 */
export const handleGridSearchBtn: Filter = ev => {
